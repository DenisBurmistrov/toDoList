...
public interface TaskEndpoint {
    ...
    @WebMethod
    @Action(input = "http://endpoint.tm.burmistrov.ru/TaskEndpoint/createTaskRequest", output = "http://endpoint.tm.burmistrov.ru/TaskEndpoint/createTaskResponse", fault = {@FaultAction(className = ParseException_Exception.class, value = "http://endpoint.tm.burmistrov.ru/TaskEndpoint/createTask/Fault/ParseException"), @FaultAction(className = IOException_Exception.class, value = "http://endpoint.tm.burmistrov.ru/TaskEndpoint/createTask/Fault/IOException"), @FaultAction(className = CloneNotSupportedException_Exception.class, value = "http://endpoint.tm.burmistrov.ru/TaskEndpoint/createTask/Fault/CloneNotSupportedException")})
