...
public class ObjectFactory {
    ...
    private final static QName _FindOneByLogin_QNAME = new QName("http://endpoint.tm.burmistrov.ru/", "findOneByLogin");
    private final static QName _FindOneByLoginResponse_QNAME = new QName("http://endpoint.tm.burmistrov.ru/", "findOneByLoginResponse");
    ...
    private final static QName _UpdateUserByLogin_QNAME = new QName("http://endpoint.tm.burmistrov.ru/", "updateUserByLogin");
    private final static QName _UpdateUserByLoginResponse_QNAME = new QName("http://endpoint.tm.burmistrov.ru/", "updateUserByLoginResponse");
    ...
    /**
     * Create an instance of {@link FindOneByLogin }
     * 
     */
    public FindOneByLogin createFindOneByLogin() {
        return new FindOneByLogin();
    }

    /**
     * Create an instance of {@link FindOneByLoginResponse }
     * 
     */
    public FindOneByLoginResponse createFindOneByLoginResponse() {
        return new FindOneByLoginResponse();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link FindOneByLogin }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://endpoint.tm.burmistrov.ru/", name = "findOneByLogin")
    public JAXBElement<FindOneByLogin> createFindOneByLogin(FindOneByLogin value) {
        return new JAXBElement<FindOneByLogin>(_FindOneByLogin_QNAME, FindOneByLogin.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link FindOneByLoginResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://endpoint.tm.burmistrov.ru/", name = "findOneByLoginResponse")
    public JAXBElement<FindOneByLoginResponse> createFindOneByLoginResponse(FindOneByLoginResponse value) {
        return new JAXBElement<FindOneByLoginResponse>(_FindOneByLoginResponse_QNAME, FindOneByLoginResponse.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoint.tm.burmistrov.ru/", name = "updateUserByLogin")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoint.tm.burmistrov.ru/", name = "updateUserByLoginResponse")
