...
public class ProjectListSortedByStatus extends AbstractCommand {
    ...
    public void execute() {
        ...
        @Nullable final List<Project> projects = getServiceLocator().getProjectEndpoint().findAllProjectsSortByStatus(Objects.requireNonNull(getServiceLocator().getSession().getUserId()));
