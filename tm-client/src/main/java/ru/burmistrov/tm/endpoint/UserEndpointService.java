...
public class UserEndpointService extends Service {
    ...
    public final static QName SERVICE = new QName("http://endpoint.tm.burmistrov.ru/", "UserEndpointService");
    public final static QName UserEndpointPort = new QName("http://endpoint.tm.burmistrov.ru/", "UserEndpointPort");
    static {
        URL url = null;
        try {
