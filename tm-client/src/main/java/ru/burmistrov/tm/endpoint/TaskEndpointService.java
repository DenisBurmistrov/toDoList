...
public class TaskEndpointService extends Service {
    ...
    public final static QName SERVICE = new QName("http://endpoint.tm.burmistrov.ru/", "TaskEndpointService");
    public final static QName TaskEndpointPort = new QName("http://endpoint.tm.burmistrov.ru/", "TaskEndpointPort");
    static {
        URL url = null;
        try {
