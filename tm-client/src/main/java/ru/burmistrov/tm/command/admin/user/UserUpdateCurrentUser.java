...
public final class UserUpdateCurrentUser extends AbstractCommand {
    ...
    public void execute() {
        ...
        getServiceLocator().getAdminEndpoint().updateUserById(Objects.requireNonNull(getServiceLocator().getSession().getUserId()), firstName, middleName, lastName, email, Role.COMMON_USER);
    }
